...
const Profile = () => (
  <div className='lg:w-[57%] '>
    ...
    <div className='relative mt-[32px]'>
      ...
      <div className='lg:absolute xl:absolute lg:top-[365px] xl:bottom-[1rem] xl:left-[33rem] xl:mt-[30px] lg:mt-[30px] mt-[60px] flex ms-[20px]'>
        ...
        <div className='lg:absolute xl:absolute lg:left-[22rem] lg:w-[2.5rem] xl:left-[11rem] xl:bottom-[2.6rem] xl:w-[2.7rem] w-[2.7rem] ms-[20px] xl:mt-3'>
          <img src={typescript} alt="" />
        </div>
        <div className='lg:absolute xl:absolute lg:flex lg:ms-[12rem] lg:w-[2.8rem] lg:items-center flex w-[2.8rem] xl:ms-[1.1rem] ms-2 xl:bottom-0 '>
