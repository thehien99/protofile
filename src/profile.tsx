...
const Profile = () => (
  <div className='xl:w-[50%] lg:w-[70%]'>
    ...
    <div className='relative mt-[32px]'>
      <img src={avatar} alt="" className='object-contain lg:w-full xl:w-[730px] xl:mt-[32px] xl:ms-[-26px] h-full' />
      <div className='sm:w-[30px] ms-[40px] lg:w-[300px] absolute lg:left-0 xl:top-[280px] xl:left-[30rem] lg:hidden xl:block '>
      ...
      <div className='absolute flex xl:bottom-[60px] xl:left-[37rem] '>
